...
(prove:subtest "Test reverse-turn"
  (prove:is (reverse-turn *white*) *black*)
  (prove:is (reverse-turn *black*) *white*))

; test direction funcs (4)
(prove:subtest "Test is-up-dir"
...
(prove:subtest "Test is-down-dir"
...
(prove:subtest "Test is-right-dir"
...
(prove:subtest "Test is-left-dir"
